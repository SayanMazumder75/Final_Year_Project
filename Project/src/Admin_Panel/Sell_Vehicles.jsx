...
export default function Dashboard() {
  ...
  const soldCars = [
    { id: 1, customerId: "CUST-101", customerName: "Soumyadip", date: "2024-08-20", name: "Auto Rickshaw", revenue: "15,000", originalPrice: "45,000", salePrice: "60,000", totalRevenue: "75,000" },
    { id: 2, customerId: "CUST-102", customerName: "Sidhu", date: "2024-08-20", name: "TOTO", revenue: "10,500", originalPrice: "55,000", salePrice: "65,500", totalRevenue: "76,000" },
    { id: 3, customerId: "CUST-103", customerName: "Anushka", date: "2024-08-20", name: "Maruti 800", revenue: "9,200", originalPrice: "50,000", salePrice: "59,200", totalRevenue: "68,400" },
    { id: 4, customerId: "CUST-104", customerName: "Nafiya", date: "2024-08-20", name: "Tata Nano", revenue: "9,000", originalPrice: "20,000", salePrice: "29,000", totalRevenue: "38,000" },
    { id: 5, customerId: "CUST-105", customerName: "Sayan", date: "2024-08-20", name: "Mercedes C-Class", revenue: "10,000", originalPrice: "47,000", salePrice: "58,000", totalRevenue: "68,000" },
    { id: 6, customerId: "CUST-106", customerName: "Rahul", date: "2024-08-20", name: "Honda Activa", revenue: "8,000", originalPrice: "35,000", salePrice: "43,000", totalRevenue: "51,000" },
    { id: 7, customerId: "CUST-107", customerName: "Priya", date: "2024-08-20", name: "Swift Dzire", revenue: "12,000", originalPrice: "50,000", salePrice: "62,000", totalRevenue: "74,000" },
  ];
  ...
  useEffect(() => {
    if (currentItems.length === 0 && filteredCars.length > 0) {
      setCurrentPage(1);
    }
  }, [filteredCars]);
        ...
        <div className="flex-1 px-3 sm:px-6 pt-4 sm:pt-6 pb-6 sm:pb-8 overflow-x-hidden md:max-w-1500">
          <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-5 gap-3">
              <h2 className="text-lg sm:text-xl font-bold text-blue-800">Already Sold Cars</h2>
              <input
                type="text"
              ...
              <table className="text-gray-700 text-xs sm:text-sm w-full">
                <thead className="bg-gray-100 text-gray-800 text-left">
                  <tr>
                    ...
                    <th className="py-2 px-3 sm:py-3 sm:px-4 border-b">Customer Name</th>
                    ...
                    <th className="py-2 px-3 sm:py-3 sm:px-4 border-b">Action</th>
                  </tr>
                </thead>
                <tbody>
                  {currentItems.length > 0 ? currentItems.map((car, index) => (
                    <tr key={car.id} className={`${index % 2 === 0 ? "bg-white" : "bg-gray-50"} hover:bg-blue-50 transition`}>
                      <td className="py-2 px-3 sm:py-3 sm:px-4 font-medium text-blue-900">{highlightText(car.customerId)}</td>
                      <td className="py-2 px-3 sm:py-3 sm:px-4">{highlightText(car.customerName)}</td>
                      <td className="py-2 px-3 sm:py-3 sm:px-4">{car.date}</td>
                      <td className="py-2 px-3 sm:py-3 sm:px-4 font-medium text-blue-900">{highlightText(car.name)}</td>
                      ...
                      <td className="py-2 px-3 sm:py-3 sm:px-4 font-semibold text-green-600">{car.totalRevenue}</td>
                    ...
                    <tr>
                      <td colSpan="9" className="text-center py-4 text-gray-500 italic">No cars found</td>
                    </tr>
                  )}
                </tbody>
              </table>

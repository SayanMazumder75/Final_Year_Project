  ...
  useEffect(() => {
    const fetchCars = async () => {
      try {
        ...
        // Filter only cars for buy
        const buyCars = data.filter((car) => car.adType === "sell");
        setCars(buyCars);
      } catch (err) {
        console.error(err);
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {cars.map((car) => (
            ...
            >
              ...
              {/* Car Image */}
              <img
                src={car.photos && car.photos[0]} // first image
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">Buy: ₹{car.price}</p>
